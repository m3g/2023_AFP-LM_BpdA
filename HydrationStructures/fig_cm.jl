#
# To obtain exact reproducibility:
# 
# Run this script with Julia 1.9.3:
# Install Julia with `juliaup`
# Install Julia 1.9.3 with `juliaup add 1.9.3`
#
# Run with:
#
# julia +1.9.3 ./fig_cm.jl
#
import Pkg
Pkg.activate(".")
Pkg.instantiate()
...
annotate!(2.0, 1.9, L"{\mathrm{N^{8}_{100}}}", 10, subplot=sp)
sp = 3
